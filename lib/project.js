...
exports.updateRequireConfig = function (package_dir, baseurl, /*opt*/rcfg, callback) {
    ...
    var map = {};
    exports.loadPackageJSON(package_dir, function(a, packageConfig, path) {
        if (packageConfig && packageConfig.jam && packageConfig.jam.config && packageConfig.jam.config.map) {
            map = packageConfig.jam.config.map;
        }
    });
